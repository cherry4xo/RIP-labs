...
class AbstractDatabaseRepo(abc.ABC):
    ...
    @abc.abstractmethod
    async def update_service(self, service_id: int, service_data: domains.ServiceUpdate) -> Optional[models.Service]: ...
    @abc.abstractmethod
    ...
    @abc.abstractmethod
    async def get_orders_with_filters(self, status: Optional[str], date_from: Optional[date], date_to: Optional[date]) -> List: ...
    @abc.abstractmethod
